...
void main() {
	...
	5. NAZIVI FUNKCIJA MORAJU BITI IDENTIÈNI ONIMA KOJI SU KORITENI U TESTNOM CODE-U.OSTALE, POMOÆNE FUNKCIJE MOETE IMENOVATI PO ELJI. TAKOÐER, MOETE DODAVATI KOLIKO ELITE TESTNIH PODATAKA
	****************************************************************************/
